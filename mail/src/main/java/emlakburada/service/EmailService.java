...
public class EmailService {
	...
	private int sendMessage(String email, Session session) {
		...
		try {
			...
			String data = EmailContentBuilderUtil.build(email);
			message.setDataHandler(new DataHandler(new HTMLDataSource(data)));
			...
			emlakburada.model.Message messageEntity = new emlakburada.model.Message();
			messageEntity.setMessage(data);
			messageEntity.setTo(email);
